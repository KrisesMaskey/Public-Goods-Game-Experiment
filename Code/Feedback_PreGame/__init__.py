...
doc = """
Feedback Condition Pre-Experiment Part
"""


class C(BaseConstants):
    NAME_IN_URL = 'Feedback_PreGame'
...
page_sequence = [ProceedPage, ConsentForm, ID, PreliminaryQuestions, Instructions, Quiz_1_Failed, Stage_2]
