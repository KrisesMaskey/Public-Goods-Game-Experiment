...
doc = """
Punishment Condition Post Experiment Part
"""


class C(BaseConstants):
    NAME_IN_URL = 'Punishment_PostGame'
...
class PEQ_6(Page):
    ...
    @staticmethod
    def live_method(player, data):
        player.peq_13 = data["inputs"][0]
        player.peq_14 = data["inputs"][1]
...
page_sequence = [EarningPage, PEQ_1, PEQ_2, PEQ_3, PEQ_e2, PEQ_4, PEQ_5, PEQ_6, Validation_Code_Page]
