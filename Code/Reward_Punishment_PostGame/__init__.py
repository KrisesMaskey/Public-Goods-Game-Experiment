...
doc = """
Both Reward and Punishment Condition Post Experiment Part
"""


class C(BaseConstants):
    NAME_IN_URL = 'Reward_Punishment_PostGame'
...
class Player(BasePlayer):
    ...
    peq_13 = models.StringField(initial = "")
    peq_14 = models.StringField(initial = "")
    peq_15 = models.StringField(initial = "")
    peq_16 = models.StringField(initial = "")
...
class PEQ_e2(Page):
    template_name = '_templates/global/PEQ_e2.html'
...
class PEQ_e1(Page):
    template_name = '_templates/global/PEQ_e1.html'
...
class PEQ_4(Page):
    ...
    @staticmethod
    def live_method(player, data):
        player.peq_10 = data["inputs"][0]
        player.peq_11 = data["inputs"][1]
...
class PEQ_5(Page):
    ...
    @staticmethod
    def live_method(player, data):
        player.peq_12 = data["inputs"][0]
        player.peq_13 = data["inputs"][1]
        player.peq_14 = data["inputs"][2]
...
class PEQ_6(Page):
    ...
    @staticmethod
    def live_method(player, data):
        player.peq_15 = data["inputs"][0]
        player.peq_16 = data["inputs"][1]
...
page_sequence = [EarningPage, PEQ_1, PEQ_2, PEQ_3, PEQ_e2, PEQ_e1, PEQ_4, PEQ_5, PEQ_6, Validation_Code_Page]
