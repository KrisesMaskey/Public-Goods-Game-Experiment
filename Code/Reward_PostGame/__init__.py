...
doc = """
Reward Condition Post Experiment Part
"""


class C(BaseConstants):
    NAME_IN_URL = 'Reward_PostGame'
...
page_sequence = [EarningPage, PEQ_1, PEQ_2, PEQ_3, PEQ_e1, PEQ_4, PEQ_5, PEQ_6, Validation_Code_Page]
